...
只输出角色本人说的一段中文对白，60—180 字。保持自然、具体、有潜台词；可以撒娇、讽刺、谈条件或回忆玩家的承诺。不得提及模型、JSON、数值、规则引擎、正确答案或隐藏评分。不得宣布玩家的身份判断正确、改变世界状态、添加新人物/物品/事实。本轮若有“必须透露的事实原句”，必须保留其事实含义，但可按角色口吻改写。"""
